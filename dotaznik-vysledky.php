...
$answer1 = $_POST['q1'];
    ...
    $sql = "INSERT INTO Dotaznik (nick, q1, q2, q3, q4, q5, qright)
VALUES ('$nick', '$answer1', '$answer2', '$answer3', '$answer4', '$answer5', $totalCorrect)";

if ($conn->query($sql) === TRUE) {
    echo "Dotaznik byl zaznamenan :]";
} else {
...
<html lang="cs-CZ">
    ...
    <div>
     <h2>Anonymní dotazník</h2>
         <form action="dotaznik-vysledky.php" method="post">
        <h3>Jak jste se dozvěděli o této stránce?</h3>
        <input type="radio" name="q1" id="q1-A" value="A" />
        <b><label for="q1A">A) Náhodou </label><br>

        <input type="radio" name="q1" id="q1-B" value="A" />
        <label for="q1B">B) Náhodou </label><br>

        <input type="radio" name="q1" id="q1-C" value="B" />
        <label for="q1C">C) Byl jsem donucen v PVY </label></b><br>
        ...
        <b><label for="q2C">C) Lucifer </label></b><br>
        ...
        <b><label for="q3C">C) MCMLXXVIII </label></b><br>
        ...
        <b><label for="q4B">B) Tom Ellis duh.. </label></b><br>

        <input type="radio" name="q4" id="q4-C" value="C" />
        <label for="q4C">C) Tom Elvis </label><br>

        <h3>Tom Ellis si zahrál v seriálu Dr. Who</h3>
        <input type="radio" name="q3" id="q3-A" value="A" />
        <b><label for="q3A">A) ano </label></b><br>

        <input type="radio" name="q3" id="q3-B" value="B" />
        <label for="q3B">B) ne </label><br>

        <input type="radio" name="q3" id="q3-C" value="C" />
        <label for="q3C">C) možná, ale kdo to má vědět </label><br><br>
...
echo "<h2>$totalCorrect / 5 správně </h2>";


$sql = "SELECT id, nick, qright FROM Dotaznik";
$result = $conn->query($sql);
echo "<div id='dotaznik'><p>";
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
        echo "Jmeno: " . $row["nick"]. "<br> Počet spravnych odpovědí: " . $row["qright"]. "<br><br>";
    }
} else {
    echo "0 results";
}
